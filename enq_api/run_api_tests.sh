...
for f in 001_rfq_core 002_triggers 003_field_policy 005_service_layer_v2 006_enq_ingest 007_enq_extraction 008_enq_orchestration 009_enq_role_split 010_rfq_signoff_v2; do
