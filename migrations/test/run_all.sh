...
END $$;
SQL
  for f in 001_rfq_core.sql 002_triggers.sql 003_field_policy.sql 005_service_layer_v2.sql 006_enq_ingest.sql 007_enq_extraction.sql 008_enq_orchestration.sql 009_enq_role_split.sql "$@"; do
    $PSQL < "$f" >/dev/null
  done
}
